...
dvCardFlip.style.backgroundColor = "#b63056" //style background color of div
...
function colorChange () { //style mouse over function
    dvCardFlip.style.backgroundColor = "#f3ec78" //change div color to pink when mouse is inside div
}
function resetColor () { //style mouse out function
    dvCardFlip.style.backgroundColor = "#b63056" //change div color to blue when mouse is outside the div
}
